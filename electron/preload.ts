...
export interface ElectronAPI {
  ...
  flushEncryptedArchives: () => Promise<boolean>;
  saveTags: (tags: string[]) => Promise<boolean>;
  loadTags: () => Promise<string[]>;
  getPasswords: () => Promise<{ archivePassword: string; tagFilePassword: string }>;
  setPasswords: (archivePw: string, tagPw: string) => Promise<boolean>;
...
const electronAPI: ElectronAPI = {
  ...
  flushEncryptedArchives: () => ipcRenderer.invoke('cache:flushEncryptedArchives'),
  saveTags: (tags: string[]) => ipcRenderer.invoke('tags:save', tags),
  loadTags: () => ipcRenderer.invoke('tags:load'),
  getPasswords: () => ipcRenderer.invoke('settings:getPasswords'),
  setPasswords: (archivePw: string, tagPw: string) => ipcRenderer.invoke('settings:setPasswords', archivePw, tagPw),
